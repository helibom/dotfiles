...
"   dial, outline, md preview, harpoon, octop <leader>sG <Action>(FindInPath)
" Help Pages
...
nmap [t ?TODO<cr>
" Next Todo t)<Action>(ChangeToolWindowLayout)
" New Tab
...
nmap <leader>sD <Action>(ActivateProblemsViewTelative Number
...
" First Tab
nmap <leader><tab>f <Action>(StoreDefaultLayou
